...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    $validation->setInput(isset($_POST['first_name']) ? $_POST['first_name'] : "")->setInputName('first_name')->required()->string()->between(2,32);
    $validation->setInput(isset($_POST['last_name']) ? $_POST['last_name'] : "")->setInputName('last_name')->required()->string()->between(2,32);
