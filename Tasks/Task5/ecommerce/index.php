...
$newProductsResult = $products->getLastProducts()->fetch_all(MYSQLI_ASSOC);
$mostProductOrdered = $products->mostOrdered()->fetch_all(MYSQLI_ASSOC);
//print_r($mostProductOrdered);
?>
    <!-- Slider Start -->
            ...
            <div class="tab-content jump">
                <div class="tab-pane active">
                    <div class="featured-product-active owl-carousel product-nav">
                        <?php foreach ($newProductsResult as $product){?>
    ...
    <div class="product-area gray-bg pt-90 pb-65">
        <div class="container">
            ...
            <div class="tab-content jump">
                <div class="tab-pane active">
                    <div class="featured-product-active owl-carousel product-nav">
                        <?php foreach ($mostProductOrdered as $product){?>
                            <div class="product-wrapper-single">
                                <div class="product-wrapper mb-30">
                                    <div class="product-img">
                                        <a href="product-details.php?id=<?= $product['id'] ?>">
