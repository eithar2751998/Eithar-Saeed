...
if($_POST){
    ...
    $review->setRate($_POST['star']);
    if($review->create()){
        echo "<p class='bg-success m-5 p-3 text-white text-center'> Comment Added Successfully</p>";
        header('refresh:3');

    }
    else
        echo "<p class='bg-danger m-5 p-3 text-white text-center'> Error </p>";
//    print_R($_POST);
//    print_r($review);
}
?>
                ...
                <div class="product-details-content">
                    ...
                    <div class="pro-dec-categories">
                        <ul>
                            ...
                            <li><a
                                    href="shop.php?category=<?= $product->category_id ?>"><?=  $product->category_name ?>,</a>
                            </li>
                            <li><a
                                    href="shop.php?subcategory=<?= $product->subcategory_id ?>"><?=  $product->subcategory_name ?>,</a>
                            </li>
